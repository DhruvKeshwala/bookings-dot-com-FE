...
export default function TravellerCounter({
  ...
  return (
    <div
      key={index}
      className="flex justify-between font-nunito items-center gap-5 font-medium   text-lg   rounded-xl"
      style={{
        // opacity: 0.8,
        textAlign: "left",
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-[40px] h-6 px-3 py-1 flex items-center text-primary justify-center rounded bg-white border border-primary ">
          {count}
        </div>
        <button
